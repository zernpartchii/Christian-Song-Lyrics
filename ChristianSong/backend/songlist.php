...
<div class="d-flex flex-wrap">
    ...
    ?>
    <div class="song-item col-sm-12 col-md-6 col-lg-3 flex-fill">
        <a href="frontend/lyrics.php?id=<?php echo $row['id']; ?>"
            class="d-flex gap-3 text-white text-decoration-none btn btn-dark mb-3 flex-fill">
    ...
    <div class="alert alert-warning d-flex w-100 mt-3">
        <p class="m-0">No Christian Song found.</p>
        <a href="index.php" class="btn-close ms-auto"></a>
    </div>
    <?php
    }
    ?>
